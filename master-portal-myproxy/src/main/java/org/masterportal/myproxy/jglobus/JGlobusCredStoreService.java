...
public class JGlobusCredStoreService implements CredStoreService {
    ...
    private static JGlobusCredStoreService instance = null;
	
    private JGlobusCredStoreService() {
    	String logProperties = System.getProperty(MYPROXY_CONFIG_LOG4J);
    ...
    public static JGlobusCredStoreService getInstance() {
    	if (instance == null) {
    		instance = new JGlobusCredStoreService();
    	}
    	return instance;
    }
