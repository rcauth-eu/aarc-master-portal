...
/*
 * A raw copy-paste org.globus.myproxy.MyProxy with every 'private' 
 * replaced to 'protected' so that this class can be further extended.
 */
/**
...
public class MyProxy  {
     ...
     * Copies certificate(s) and protected key directly to the server rather
     ...
     * @param  key
     *         The protected key to store (typically encrypted).
     * @param  params
     ...
     *
     * Notes: Performs simple verification of protected/public keys of
