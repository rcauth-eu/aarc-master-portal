...
public class CertUtil {
    ...
    public static String fromCertReqToString(MyPKCS10CertRequest certReq) {
        ...
        return Base64.encodeBase64String(certReq.getEncoded());
    }
     ...
     * @throws IOException
     */
    public static MyPKCS10CertRequest createCertRequest(KeyPair keypair, String dn) throws SignatureException,
    ...
    public static MyPKCS10CertRequest createCertRequest(KeyPair keypair,
                                                        String sigAlgName,
                                                        String dn,
                                                        String provider) throws SignatureException,
            InvalidKeyException, NoSuchProviderException, NoSuchAlgorithmException, IOException {
     ...
     * the cert. Since that requires a bit of Voodoo to get, this call will perform that,
